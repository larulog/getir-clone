...
const Header = () => {
  return (
    <div className="bg-brand-color sticky top-0 right-0 z-50">
      <div className="container mx-auto h-16 md:h-11 flex items-center justify-center md:justify-between">
        ...
        <nav className="hidden md:flex gap-x-8 text-sm font-semibold">
          <a
            ...
            className="text-white text-opacity-75 hover:text-opacity-100 flex items-center gap-x-1"
          >
            <BsGlobe size={20} className="mr-2" />
            Türkçe (TR)
          </a>
          <a
            href="http://localhost:3000/"
            className="text-white text-opacity-75 hover:text-opacity-100 flex items-center gap-x-1"
          >
            <RiUserFill size={20} className="mr-2"/>
            Giriş Yap
          </a>
          <a
            href="http://localhost:3000/"
            className="text-white text-opacity-75 hover:text-opacity-100 flex items-center gap-x-1"
          >
            <RiUserAddFill size={20} className="mr-2"/>
            Kayıt Ol
          </a>
        </nav>
      </div>
